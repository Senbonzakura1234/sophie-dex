import APISingleWrapper from '@root/components/layout/client/ApiWrapper/item';
...
export async function generateMetadata({ params }: PageProps, parent: ResolvingMetadata): Promise<Metadata> {
	...
	return generateDetailMetadata(parent, helpers.item.getOne.fetch(params), dehydrate);
}
