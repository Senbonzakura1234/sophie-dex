...
export default function ListboxButton<V extends string | number>({
	...
	return (
		<Listbox.Button
			className={`relative w-full rounded-lg bg-base-100 px-4 py-2 text-left text-xs shadow-lg shadow-base-content/20 focus:outline-none focus-visible:border-primary focus-visible:ring-2 focus-visible:ring-base-100/75 focus-visible:ring-offset-2 focus-visible:ring-offset-secondary xl:text-sm ${
