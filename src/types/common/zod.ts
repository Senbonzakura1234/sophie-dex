...
export const relatedCategorySchema = z.enum(relatedCategoryList).nullish().catch(null).default(null);
...
export const idSchema = z.string().regex(idRegex).nullish().catch(null).default(null);
